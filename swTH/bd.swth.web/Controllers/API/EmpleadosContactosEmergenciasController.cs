    ...
    public class EmpleadosContactosEmergenciasController : Controller
    {
        ...
        public async Task<Response> PutEmpleadoContactoEmergencia([FromRoute] int id, [FromBody] EmpleadoContactoEmergencia empleadoContactoEmergencia)
        {
            try
            {
                ...
                if (existe.IsSuccess)
                {
                    if (EmpleadoContactoEmergenciaActualizar.IdEmpleadoContactoEmergencia == empleadoContactoEmergencia.IdEmpleadoContactoEmergencia)
                    {
                        return new Response
                        {
                            IsSuccess = true,
                ...
                EmpleadoContactoEmergencia.IdEmpleado = empleadoContactoEmergencia.IdEmpleado;
        ...
        {
            var nombres = EmpleadoContactoEmergencia.Persona.Nombres.ToUpper().TrimEnd().TrimStart();
            var apellidos = EmpleadoContactoEmergencia.Persona.Apellidos.ToUpper().TrimEnd().TrimStart();
            var EmpleadoContactoEmergenciarespuesta = db.EmpleadoContactoEmergencia.Where(p => p.Persona.Nombres.ToUpper().TrimStart().TrimEnd() == nombres && p.Persona.Apellidos == apellidos&&p.IdEmpleado== EmpleadoContactoEmergencia.IdEmpleado && p.IdParentesco==EmpleadoContactoEmergencia.IdParentesco).FirstOrDefault();
