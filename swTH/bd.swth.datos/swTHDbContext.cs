...
namespace bd.swth.datos
{
    public class SwTHDbContext : DbContext
    {
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.ActividadesAnalisisOcupacional> ActividadesAnalisisOcupacional { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.AdministracionTalentoHumano> AdministracionTalentoHumano { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.AnoExperiencia> AnoExperiencia { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.AprobacionViatico> AprobacionViatico { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.CandidatoConcurso> CandidatoConcurso { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Canditato> Canditato { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionEncuesta> CapacitacionEncuesta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionModalidad> CapacitacionModalidad { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionPlanificacion> CapacitacionPlanificacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionPregunta> CapacitacionPregunta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionProveedor> CapacitacionProveedor { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionRecibida> CapacitacionRecibida { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionRespuesta> CapacitacionRespuesta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionTemario> CapacitacionTemario { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionTemarioProveedor> CapacitacionTemarioProveedor { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.CapacitacionTipoPregunta> CapacitacionTipoPregunta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Ciudad> Ciudad { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.DatosBancarios> DatosBancarios { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.DependenciaDocumento> DependenciaDocumento { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Destreza> Destreza { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.DetalleExamenInduccion> DetalleExamenInduccion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.DocumentosParentescodos> DocumentosParentescodos { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Empleado> Empleado { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadoContactoEmergencia> EmpleadoContactoEmergencia { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadoFamiliar> EmpleadoFamiliar { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadoFormularioCapacitacion> EmpleadoFormularioCapacitacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadoIE> EmpleadoIE { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadoImpuestoRenta> EmpleadoImpuestoRenta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadoMovimiento> EmpleadoMovimiento { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadoNepotismo> EmpleadoNepotismo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadoSaldoVacaciones> EmpleadoSaldoVacaciones { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EmpleadosFormularioDevengacion> EmpleadosFormularioDevengacion { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.Eval001> Eval001 { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionActividadesPuestoTrabajo> EvaluacionActividadesPuestoTrabajo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionActividadesPuestoTrabajoDetalle> EvaluacionActividadesPuestoTrabajoDetalle { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionActividadesPuestoTrabajoFactor> EvaluacionActividadesPuestoTrabajoFactor { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionCompetenciasTecnicasPuesto> EvaluacionCompetenciasTecnicasPuesto { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionCompetenciasTecnicasPuestoDetalle> EvaluacionCompetenciasTecnicasPuestoDetalle { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionCompetenciasTecnicasPuestoFactor> EvaluacionCompetenciasTecnicasPuestoFactor { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionCompetenciasUniversales> EvaluacionCompetenciasUniversales { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionCompetenciasUniversalesDetalle> EvaluacionCompetenciasUniversalesDetalle { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionCompetenciasUniversalesFactor> EvaluacionCompetenciasUniversalesFactor { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionConocimiento> EvaluacionConocimiento { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionConocimientoDetalle> EvaluacionConocimientoDetalle { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionConocimientoFactor> EvaluacionConocimientoFactor { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionInducion> EvaluacionInducion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionTrabajoEquipoIniciativaLiderazgo> EvaluacionTrabajoEquipoIniciativaLiderazgo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionTrabajoEquipoIniciativaLiderazgoDetalle> EvaluacionTrabajoEquipoIniciativaLiderazgoDetalle { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.EvaluacionTrabajoEquipoIniciativaLiderazgoFactor> EvaluacionTrabajoEquipoIniciativaLiderazgoFactor { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Evaluador> Evaluador { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Exepciones> Exepciones { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.ExperienciaLaboralRequerida> ExperienciaLaboralRequerida { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Factor> Factor { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.FacturaViatico> FacturaViatico { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.FaseConcurso> FaseConcurso { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.FondoFinanciamiento> FondoFinanciamiento { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.FormularioAnalisisOcupacional> FormularioAnalisisOcupacional { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.FormularioCapacitacion> FormularioCapacitacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.FormularioDevengacion> FormularioDevengacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.FormulasRMU> FormulasRMU { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.FrecuenciaAplicacion> FrecuenciaAplicacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.GastoRubro> GastoRubro { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Genero> Genero { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.GrupoOcupacional> GrupoOcupacional { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Indicador> Indicador { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.IndiceOcupacional> IndiceOcupacional { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.IndiceOcupacionalActividadesEsenciales> IndiceOcupacionalActividadesEsenciales { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.IndiceOcupacionalAreaConocimiento> IndiceOcupacionalAreaConocimiento { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.InformeUATH> InformeUATH { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.InformeViatico> InformeViatico { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.IngresoEgresoRMU> IngresoEgresoRMU { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.InstitucionFinanciera> InstitucionFinanciera { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.ItemViatico> ItemViatico { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.ItinerarioViatico> ItinerarioViatico { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Liquidacion> Liquidacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.ManualPuesto> ManualPuesto { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.MaterialApoyo> MaterialApoyo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Mision> Mision { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.MisionIndiceOcupacional> MisionIndiceOcupacional { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.ModalidadPartida> ModalidadPartida { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.ModosScializacion> ModosScializacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Nacionalidad> Nacionalidad { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.NacionalidadIndigena> NacionalidadIndigena { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Nivel> Nivel { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.NivelConocimiento> NivelConocimiento { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.NivelDesarrollo> NivelDesarrollo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Pais> Pais { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PaquetesInformaticos> PaquetesInformaticos { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Parentesco> Parentesco { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Parroquia> Parroquia { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PartidasFase> PartidasFase { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Permiso> Permiso { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Persona> Persona { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PersonaCapacitacion> PersonaCapacitacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PersonaDiscapacidad> PersonaDiscapacidad { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PersonaEnfermedad> PersonaEnfermedad { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PersonaEstudio> PersonaEstudio { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PersonaPaquetesInformaticos> PersonaPaquetesInformaticos { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PlanGestionCambio> PlanGestionCambio { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PlanificacionHE> PlanificacionHE { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Pregunta> Pregunta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.PreguntaRespuesta> PreguntaRespuesta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Proceso> Proceso { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.ProcesoDetalle> ProcesoDetalle { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Provincia> Provincia { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Provisiones> Provisiones { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RealizaExamenInduccion> RealizaExamenInduccion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RegimenLaboral> RegimenLaboral { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RegistroEntradaSalida> RegistroEntradaSalida { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RelacionLaboral> RelacionLaboral { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RelacionesInternasExternas> RelacionesInternasExternas { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.Relevancia> Relevancia { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RequisitosNoCumple> RequisitosNoCumple { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Respuesta> Respuesta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RMU> RMU { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RolPagoDetalle> RolPagoDetalle { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RolPagos> RolPagos { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RolPuesto> RolPuesto { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Rubro> Rubro { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.RubroLiquidacion> RubroLiquidacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Sexo> Sexo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.SituacionPropuesta> SituacionPropuesta { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.SolicitudAcumulacionDecimos> SolicitudAcumulacionDecimos { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.SolicitudAnticipo> SolicitudAnticipo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.SolicitudCertificadoPersonal> SolicitudCertificadoPersonal { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.SolicitudHorasExtras> SolicitudHorasExtras { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.SolicitudLiquidacionHaberes> SolicitudLiquidacionHaberes { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.SolicitudModificacionFichaEmpleado> SolicitudModificacionFichaEmpleado { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.SolicitudPermiso> SolicitudPermiso { get; set; }
        ...
        public virtual DbSet<bd.swth.entidades.Negocio.Sucursal> Sucursal { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoAccionPersonal> TipoAccionPersonal { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoCertificado> TipoCertificado { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoConcurso> TipoConcurso { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoDiscapacidad> TipoDiscapacidad { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoEnfermedad> TipoEnfermedad { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoIdentificacion> TipoIdentificacion { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoMovimientoInterno> TipoMovimientoInterno { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoNombramiento> TipoNombramiento { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoPermiso> TipoPermiso { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoProvision> TipoProvision { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoRMU> TipoRMU { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoSangre> TipoSangre { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoTransporte> TipoTransporte { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TipoViatico> TipoViatico { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.Titulo> Titulo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TrabajoEquipoIniciativaLiderazgo> TrabajoEquipoIniciativaLiderazgo { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.TrayectoriaLaboral> TrayectoriaLaboral { get; set; }
        public virtual DbSet<bd.swth.entidades.Negocio.ValidacionInmediatoSuperior> ValidacionInmediatoSuperior { get; set; }
