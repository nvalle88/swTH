...
namespace bd.sw.externos.NUevosModels
{
    public partial class zeusbdeContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.AntecedenteAccidenteTrabajo'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.AntecedenteFamiliar'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.AntecedenteLaboral'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CATEGORY'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.AntecedenteEnfermedadProfesional'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.COMMENT'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.AntecedenteMedico'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Vacuna'. Please see the warning messages.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ExperienciaLaboralRequerida>(entity =>
            {
                ...
                entity.HasIndex(e => e.AnoExperiencia)
                    .HasName("Ref228351");
            ...
            modelBuilder.Entity<PersonaSustituto>(entity =>
            {
                ...
                entity.HasOne(d => d.IdPersonaNavigation)
                    .WithOne(p => p.PersonaSustitutoIdPersonaNavigation)
                ...
                entity.HasOne(d => d.IdPersonaDiscapacidadNavigation)
                    .WithOne(p => p.PersonaSustitutoIdPersonaDiscapacidadNavigation)
